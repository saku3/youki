...
fn main() -> Result<()> {
    ...
    let _poststart = get_poststart_tests();
    let _poststop = get_poststop_tests();
    let _poststart_fail = get_poststart_fail_tests();
    let _prestart = get_prestart_tests();
    let _create_runtime = get_create_runtime_tests();
    let _prestart_fail = get_prestart_fail_tests();
    ...
    let _cgroup_v1_absolute_network = cgroups::network::absolute_network::get_test_group();
    let _cgroup_v1_relative_network = cgroups::network::relative_network::get_test_group();
    ...
    let _misc_props = get_misc_props_test();
    ...
    let _memory_policy = get_linux_memory_policy_tests();
    let _io_priority_test = get_io_priority_test();
    let _delete = get_delete_test();
    ...
    let _process_rlimits_fail = get_process_rlimits_fail_test();
    ...
    let _kill = get_kill_test();
    let _kill_no_effect = get_kill_no_effect_test();
    let _masked_paths = get_linux_masked_paths_tests();
    let _rootfs_propagation = get_rootfs_propagation_test();
    let _process_capabilities_fail = get_process_capabilities_fail_test();
    let _uid_mappings = get_uid_mappings_test();
    let _exec_cpu_affinity = get_exec_cpu_affinity_test();
    let exec = get_exec_test();
    let _personality = get_personality_test();
    let _prohibit_symlink = get_prohibit_symlink_test();
    let _net_devices = get_net_devices_test();
