...
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/seccomp-notify.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/checkpoint.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/host-mntns.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/create.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/userns.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/selinux.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/exec.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/timens.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/dev.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/cwd.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/start_detached.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/mask.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/capabilities.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/cgroup_delegation.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/state.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/rlimits.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/ps.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/spec.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/idmap.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/update.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/mounts_propagation.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/hooks_so.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/start_hello.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/hooks.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/debug.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/mounts_sshfs.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/delete.bats'
# sudo -E PATH="$PATH" script -q -e -c 'bats -t tests/integration/start.bats'
