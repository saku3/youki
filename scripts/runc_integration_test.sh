...
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/root.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/kill.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/pause.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/seccomp.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/version.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/scheduler.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/no_pivot.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/root.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/personality.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/list.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/help.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/cpu_affinity.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/run.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/mounts_recursive.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/events.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/pidfd-socket.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/mounts.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/env.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/cgroups.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/tty.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/seccomp-notify-compat.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/seccomp-notify.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/checkpoint.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/host-mntns.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/create.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/userns.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/selinux.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/exec.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/timens.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/dev.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/cwd.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/start_detached.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/mask.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/capabilities.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/cgroup_delegation.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/state.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/rlimits.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/ps.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/spec.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/idmap.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/update.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/mounts_propagation.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/hooks_so.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/start_hello.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/hooks.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/debug.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/mounts_sshfs.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/delete.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/start.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/ioprio.bats'
sudo -E PATH="$PATH" script -q -e -c 'bats --trace -t tests/integration/umask.bats'
